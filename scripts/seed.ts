...
- Testing and deployment`,
  ...
  // ─── Course Reviews ───
  // Star ratings from enrolled students only (one per student per course).
  // course1 → avg 4.5 (4 ratings); course2 → avg 4.0 (3 ratings).
  db.insert(schema.courseReviews)
    .values([
      { userId: students[0].id, courseId: course1.id, rating: 5, createdAt: daysAgo(20) },
      { userId: students[1].id, courseId: course1.id, rating: 4, createdAt: daysAgo(9) },
      { userId: students[2].id, courseId: course1.id, rating: 5, createdAt: daysAgo(18) },
      { userId: students[4].id, courseId: course1.id, rating: 4, createdAt: daysAgo(5) },
      { userId: students[0].id, courseId: course2.id, rating: 4, createdAt: daysAgo(15) },
      { userId: students[2].id, courseId: course2.id, rating: 3, createdAt: daysAgo(12) },
      { userId: students[3].id, courseId: course2.id, rating: 5, createdAt: daysAgo(8) },
    ])
    .run();
